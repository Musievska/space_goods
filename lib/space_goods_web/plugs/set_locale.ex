defmodule SpaceGoodsWeb.Plugs.SetLocale do
  import Plug.Conn
  ...
  defp rewrite_path(%{request_path: request_path} = conn, requested_locale, config) do
    ...
    |> prepend_locale_to_path(locale)
  end

  defp prepend_locale_to_path("/", locale), do: "/#{locale}"
...
#       locale = if locale == "bg", do: "bg", else: locale
