...
config :space_goods,
  ecto_repos: [SpaceGoods.Repo]

# Configures the endpoint
config :space_goods, SpaceGoodsWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: SpaceGoodsWeb.ErrorHTML, json: SpaceGoodsWeb.ErrorJSON],
    layout: false
  ],
...
config :space_goods, SpaceGoods.Mailer, adapter: Swoosh.Adapters.Local
